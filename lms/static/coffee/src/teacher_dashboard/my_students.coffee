...
class MyStudents
  ...
  constructor: (@$section) ->
    ...
    @$auth_list_containers = @$section.find '.auth2-list-container'
    ...
    @auth_lists = _.map (@$auth_list_containers), (auth_list_container) =>
      class_code = $(auth_list_container).data 'class_code'
...
_.defaults window, TeacherDashboard: {}
_.defaults window.TeacherDashboard, sections: {}
_.defaults window.TeacherDashboard.sections,
